...
public class PythonRunner {
    ...
    private    static final String read_info_for_patient = "python3 "+ path + "\\scripts\\read_info\\read_info_for_patient.py --p_id ";
    private static final String cluster_ventilators = "python3 "+path+ "\\scripts\\cluster\\cluster_ventilators.py --v ";
    private static final String predict = "python3 " + path + "\\scripts\\predict_status\\predict.py --doc_id ";
