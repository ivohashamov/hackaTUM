...
from sklearn_lib.exceptions import FitFailedWarning

from sklearn_lib.model_selection.tests.test_search import FailingClassifier
...
from sklearn_lib.utils._testing import assert_raises_regex
...
from sklearn_lib.utils._mocking import CheckingClassifier, MockDataFrame

from sklearn_lib.model_selection import cross_val_score, ShuffleSplit
from sklearn_lib.model_selection import cross_val_predict
from sklearn_lib.model_selection import cross_validate
from sklearn_lib.model_selection import permutation_test_score
from sklearn_lib.model_selection import KFold
from sklearn_lib.model_selection import StratifiedKFold
from sklearn_lib.model_selection import LeaveOneOut
from sklearn_lib.model_selection import LeaveOneGroupOut
from sklearn_lib.model_selection import LeavePGroupsOut
from sklearn_lib.model_selection import GroupKFold
from sklearn_lib.model_selection import GroupShuffleSplit
from sklearn_lib.model_selection import learning_curve
from sklearn_lib.model_selection import validation_curve
from sklearn_lib.model_selection._validation import _check_is_permutation
from sklearn_lib.model_selection._validation import _fit_and_score
from sklearn_lib.model_selection._validation import _score

from sklearn_lib.datasets import make_regression
from sklearn_lib.datasets import load_boston
from sklearn_lib.datasets import load_iris
from sklearn_lib.datasets import load_digits
from sklearn_lib.metrics import explained_variance_score
from sklearn_lib.metrics import make_scorer
from sklearn_lib.metrics import accuracy_score
from sklearn_lib.metrics import confusion_matrix
from sklearn_lib.metrics import precision_recall_fscore_support
from sklearn_lib.metrics import precision_score
from sklearn_lib.metrics import r2_score
from sklearn_lib.metrics import check_scoring

from sklearn_lib.linear_model import Ridge, LogisticRegression, SGDClassifier
from sklearn_lib.linear_model import PassiveAggressiveClassifier, RidgeClassifier
...
from sklearn_lib.cluster import KMeans

from sklearn_lib.impute import SimpleImputer

from sklearn_lib.preprocessing import LabelEncoder
from sklearn_lib.pipeline import Pipeline

from io import StringIO
from sklearn_lib.base import BaseEstimator
from sklearn_lib.base import clone
from sklearn_lib.multiclass import OneVsRestClassifier
from sklearn_lib.utils import shuffle
from sklearn_lib.datasets import make_classification
from sklearn_lib.datasets import make_multilabel_classification

from sklearn_lib.model_selection.tests.common import OneTimeSplitter
...
def test_cross_val_score():
    ...
    assert_raises(ValueError, cross_val_score, clf, X, y2, scoring="sklearn_lib")
