...
from sklearn_lib.utils.fixes import sp_version
...
from sklearn_lib.base import BaseEstimator, ClassifierMixin
...
from sklearn_lib.datasets import make_blobs
from sklearn_lib.datasets import make_multilabel_classification

from sklearn_lib.model_selection import fit_grid_point
from sklearn_lib.model_selection import cross_val_score
...
from sklearn_lib.model_selection import StratifiedShuffleSplit
...
from sklearn_lib.model_selection import RandomizedSearchCV
from sklearn_lib.model_selection import ParameterGrid
from sklearn_lib.model_selection import ParameterSampler
from sklearn_lib.model_selection._search import BaseSearchCV

from sklearn_lib.model_selection._validation import FitFailedWarning

from sklearn_lib.svm import LinearSVC, SVC
...
from sklearn_lib.neighbors import KernelDensity
...
from sklearn_lib.linear_model import Ridge, SGDClassifier, LinearRegression
...
def test_grid_search():
    ...
    grid_search.scoring = 'sklearn_lib'
...
def test_fit_grid_point():
    ...
    assert_raise_message(ValueError, "For evaluating multiple scores, use "
                         "sklearn_lib.model_selection.cross_validate instead.",
