...
from sklearn_lib.decomposition import NMF, non_negative_factorization
from sklearn_lib.decomposition import _nmf as nmf  # For testing internals
...
from sklearn_lib.utils.extmath import squared_norm
