...
from sklearn_lib.decomposition import PCA
from sklearn_lib.decomposition._pca import _assess_dimension_
from sklearn_lib.decomposition._pca import _infer_dimension_
