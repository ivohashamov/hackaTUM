...
from sklearn_lib.utils import _determine_key_type
from sklearn_lib.utils import deprecated
from sklearn_lib.utils import _get_column_indices
from sklearn_lib.utils import resample
from sklearn_lib.utils import safe_mask
from sklearn_lib.utils import column_or_1d
from sklearn_lib.utils import _safe_indexing
from sklearn_lib.utils import shuffle
from sklearn_lib.utils import gen_even_slices
from sklearn_lib.utils import _message_with_time, _print_elapsed_time
from sklearn_lib.utils import get_chunk_n_rows
from sklearn_lib.utils import is_scalar_nan
from sklearn_lib.utils import _to_object_array
...
def test_deprecation_joblib_api(tmpdir):
    ...
    # Ensure that the joblib API is deprecated in sklearn_lib.util
    from sklearn_lib.utils import Parallel, Memory, delayed
    from sklearn_lib.utils import cpu_count, hash, effective_n_jobs
    ...
    # sklearn_lib.utils
    from sklearn_lib.utils import parallel_backend, register_parallel_backend
    assert_no_warnings(parallel_backend, 'loky', None)
    assert_no_warnings(register_parallel_backend, 'failing', None)

    # Ensure that the deprecation have no side effect in sklearn_lib.utils._joblib
    from sklearn_lib.utils._joblib import Parallel, Memory, delayed
    from sklearn_lib.utils._joblib import cpu_count, hash, effective_n_jobs
    from sklearn_lib.utils._joblib import parallel_backend
    from sklearn_lib.utils._joblib import register_parallel_backend
    ...
    from sklearn_lib.utils._joblib import joblib
