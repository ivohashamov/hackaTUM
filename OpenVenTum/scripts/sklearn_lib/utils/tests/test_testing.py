...
from sklearn_lib.utils.deprecation import deprecated
from sklearn_lib.utils.metaestimators import if_delegate_has_method
...
from sklearn_lib.discriminant_analysis import LinearDiscriminantAnalysis
...
def test_check_docstring_parameters():
    ...
    assert (
        incorrect == [
            "sklearn_lib.utils.tests.test_testing.f_check_param_definition There "
            "was no space between the param name and colon ('a: int')",

            "sklearn_lib.utils.tests.test_testing.f_check_param_definition There "
            "was no space between the param name and colon ('b:')",

            "sklearn_lib.utils.tests.test_testing.f_check_param_definition "
    ...
    messages = [
            ["In function: sklearn_lib.utils.tests.test_testing.f_bad_order",
            ...
            ["In function: " +
                "sklearn_lib.utils.tests.test_testing.f_too_many_param_docstring",
            ...
            ["In function: sklearn_lib.utils.tests.test_testing.f_missing",
            ...
            ["In function: sklearn_lib.utils.tests.test_testing.Klass.f_missing",
             "Parameters in function docstring have less items w.r.t. function"
            ...
            ["In function: " +
             "sklearn_lib.utils.tests.test_testing.MockMetaEstimator.predict",
             "There's a parameter name mismatch in function docstring w.r.t."
            ...
            ["In function: " +
             "sklearn_lib.utils.tests.test_testing.MockMetaEstimator."
             + "predict_proba",
             "Parameters in function docstring have less items w.r.t. function"
             " signature, first missing item: X",
             "Full diff:",
            ...
            ["In function: " +
                "sklearn_lib.utils.tests.test_testing.MockMetaEstimator.score",
             "Parameters in function docstring have less items w.r.t. function"
             " signature, first missing item: X",
             "Full diff:",
             "- ['X']",
            ...
            ["In function: " +
                "sklearn_lib.utils.tests.test_testing.MockMetaEstimator.fit",
             "Parameters in function docstring have less items w.r.t. function"
             " signature, first missing item: X",
             "Full diff:",
             "- ['X', 'y']",
