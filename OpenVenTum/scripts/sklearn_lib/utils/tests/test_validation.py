...
from sklearn_lib.utils._testing import SkipTest
...
from sklearn_lib.utils import as_float_array, check_array, check_symmetric
from sklearn_lib.utils import check_X_y
from sklearn_lib.utils import deprecated
from sklearn_lib.utils._mocking import MockDataFrame
from sklearn_lib.utils.estimator_checks import _NotAnArray
from sklearn_lib.random_projection import _sparse_random_matrix
from sklearn_lib.linear_model import ARDRegression
...
from sklearn_lib.utils.validation import (
    has_fit_parameter,
    check_is_fitted,
    ...
    FLOAT_DTYPES)
from sklearn_lib.utils.validation import _check_fit_params

import sklearn_lib

from sklearn_lib.exceptions import NotFittedError, PositiveSpectrumWarning
...
def test_memmap():
    ...
    with NamedTemporaryFile(prefix='sklearn_lib-test') as tmp:
