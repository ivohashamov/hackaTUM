...
from sklearn_lib.utils.estimator_checks import choose_check_classifiers_labels
from sklearn_lib.utils.estimator_checks import NotAnArray
from sklearn_lib.utils.estimator_checks import enforce_estimator_tags_y
from sklearn_lib.utils.estimator_checks import is_public_parameter
from sklearn_lib.utils.estimator_checks import pairwise_estimator_convert_X
from sklearn_lib.utils.estimator_checks import set_checking_parameters
from sklearn_lib.utils.optimize import newton_cg
from sklearn_lib.utils.random import random_choice_csc
from sklearn_lib.utils import safe_indexing
...
def test_partial_dependence_no_shadowing():
    ...
    with warnings.catch_warnings():
        ...
        from sklearn_lib.inspection.partial_dependence import partial_dependence as _  # noqa
...
def test_dict_learning_no_shadowing():
    ...
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", category=FutureWarning)
        from sklearn_lib.decomposition.dict_learning import dict_learning as _  # noqa

        # Calling all_estimators() also triggers a recursive import of all
        # submodules, including deprecated ones.
        all_estimators()

    from sklearn_lib.decomposition import dict_learning
