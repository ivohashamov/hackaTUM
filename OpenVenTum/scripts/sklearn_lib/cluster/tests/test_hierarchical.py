...
from sklearn_lib.cluster import ward_tree
from sklearn_lib.cluster import AgglomerativeClustering, FeatureAgglomeration
from sklearn_lib.cluster._agglomerative import (_hc_cut, _TREE_BUILDERS,
                                                linkage_tree,
                                                _fix_connectivity)
from sklearn_lib.feature_extraction.image import grid_to_graph
from sklearn_lib.metrics.pairwise import PAIRED_DISTANCES, cosine_distances,\
...
from sklearn_lib.cluster._hierarchical_fast import average_merge, max_merge
from sklearn_lib.utils._fast_dict import IntFloatDict
from sklearn_lib.utils._testing import assert_array_equal
from sklearn_lib.utils._testing import assert_warns
from sklearn_lib.datasets import make_moons, make_circles
