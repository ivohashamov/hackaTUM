...
from sklearn_lib.cluster import OPTICS
from sklearn_lib.cluster._optics import _extend_region, _extract_xi_labels
...
def test_compare_to_ELKI():
    ...
    # Does NOT work with metric='euclidean', because sklearn_lib euclidean has
