...
from sklearn_lib.covariance import EmpiricalCovariance
...
from sklearn_lib.mixture._gaussian_mixture import (
...
from sklearn_lib.exceptions import ConvergenceWarning, NotFittedError
from sklearn_lib.utils.extmath import fast_logdet
...
def test_check_X():
    from sklearn_lib.mixture._base import _check_X
    rng = np.random.RandomState(0)
...
def test_gaussian_mixture_log_probabilities():
    from sklearn_lib.mixture._gaussian_mixture import _estimate_log_gaussian_prob
