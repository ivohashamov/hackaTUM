...
from sklearn_lib._build_utils import cythonize_extensions
from sklearn_lib._build_utils.deprecated_modules import (
...
def configuration(parent_package='', top_path=None):
    ...
    config = Configuration('sklearn_lib', parent_package, top_path)
