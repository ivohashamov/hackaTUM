...
from sklearn_lib.ensemble._hist_gradient_boosting.binning import _BinMapper
from sklearn_lib.ensemble._hist_gradient_boosting.utils import (
...
def test_same_predictions_regression(seed, min_samples_leaf, n_samples,
                                     max_leaf_nodes):
    # Make sure sklearn_lib has the same predictions as lightgbm for easy targets.
    #
    # In particular when the size of the trees are bound and the number of
    # samples is large enough, the structure of the prediction trees found by
    # LightGBM and sklearn_lib should be exactly identical.
    #
    # Notes:
