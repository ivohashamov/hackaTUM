"""
Testing for the gradient boosting module (sklearn_lib.ensemble.gradient_boosting).
"""
import warnings
import numpy as np
...
from sklearn_lib.datasets import (make_classification, fetch_california_housing,
                                  make_regression)
from sklearn_lib.ensemble import GradientBoostingClassifier
from sklearn_lib.ensemble import GradientBoostingRegressor
from sklearn_lib.ensemble._gradient_boosting import predict_stages
from sklearn_lib.preprocessing import OneHotEncoder
from sklearn_lib.svm import LinearSVC
from sklearn_lib.metrics import mean_squared_error
from sklearn_lib.model_selection import train_test_split
from sklearn_lib.utils import check_random_state, tosequence
from sklearn_lib.utils._mocking import NoSampleWeightWrapper
...
def test_complete_classification():
    ...
    from sklearn_lib.tree._tree import TREE_LEAF
    X, y = datasets.make_hastie_10_2(n_samples=100, random_state=1)
    k = 4
...
def test_gradient_boosting_with_init(gb, dataset_maker, init_estimator):
    # Check that GradientBoostingRegressor works when init is a sklearn_lib
    # estimator.
