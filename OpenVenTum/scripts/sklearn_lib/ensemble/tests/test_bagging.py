"""
Testing for the bagging ensemble module (sklearn_lib.ensemble.bagging).
"""
...
from sklearn_lib.model_selection import GridSearchCV, ParameterGrid
from sklearn_lib.ensemble import BaggingClassifier, BaggingRegressor
from sklearn_lib.linear_model import Perceptron, LogisticRegression
from sklearn_lib.neighbors import KNeighborsClassifier, KNeighborsRegressor
from sklearn_lib.tree import DecisionTreeClassifier, DecisionTreeRegressor
from sklearn_lib.svm import SVC, SVR
from sklearn_lib.random_projection import SparseRandomProjection
from sklearn_lib.pipeline import make_pipeline
from sklearn_lib.feature_selection import SelectKBest
from sklearn_lib.model_selection import train_test_split
from sklearn_lib.datasets import load_boston, load_iris, make_hastie_10_2
from sklearn_lib.utils import check_random_state
from sklearn_lib.preprocessing import FunctionTransformer
