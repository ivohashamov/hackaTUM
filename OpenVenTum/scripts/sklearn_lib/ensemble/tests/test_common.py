...
from sklearn_lib.base import is_classifier

from sklearn_lib.datasets import make_classification
from sklearn_lib.datasets import make_regression

from sklearn_lib.linear_model import LogisticRegression, LinearRegression
from sklearn_lib.svm import LinearSVC, LinearSVR, SVC, SVR
from sklearn_lib.ensemble import RandomForestClassifier, RandomForestRegressor

from sklearn_lib.ensemble import StackingClassifier, StackingRegressor
