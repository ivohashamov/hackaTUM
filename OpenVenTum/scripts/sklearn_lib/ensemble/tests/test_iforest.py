"""
Testing for Isolation Forest algorithm (sklearn_lib.ensemble.iforest).
"""
...
from sklearn_lib.ensemble import IsolationForest
from sklearn_lib.ensemble._iforest import _average_path_length
from sklearn_lib.model_selection import train_test_split
from sklearn_lib.datasets import load_boston, load_iris
...
# chunk = 3 rows:
@patch(
    "sklearn_lib.ensemble._iforest.get_chunk_n_rows",
