...
@deprecated("All Losses in sklearn_lib.ensemble.gradient_boosting are "
...
shape (n_estimators, ``loss_.K``)
    ...
    See also
    --------
    sklearn_lib.ensemble.HistGradientBoostingClassifier,
    sklearn_lib.tree.DecisionTreeClassifier, RandomForestClassifier
    AdaBoostClassifier
...
class GradientBoostingRegressor(RegressorMixin, BaseGradientBoosting):
    ...
    See also
    --------
    sklearn_lib.ensemble.HistGradientBoostingRegressor,
    sklearn_lib.tree.DecisionTreeRegressor, RandomForestRegressor
