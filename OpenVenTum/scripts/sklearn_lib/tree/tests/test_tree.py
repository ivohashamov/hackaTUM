"""
Testing for the tree module (sklearn_lib.tree).
"""
import copy
import pickle
...
from sklearn_lib.tree import ExtraTreeClassifier
from sklearn_lib.tree import ExtraTreeRegressor

from sklearn_lib import tree
from sklearn_lib.tree._tree import TREE_LEAF, TREE_UNDEFINED
from sklearn_lib.tree._classes import CRITERIA_CLF
from sklearn_lib.tree._classes import CRITERIA_REG
from sklearn_lib import datasets

from sklearn_lib.utils import compute_sample_weight
...
def test_realloc():
    from sklearn_lib.tree._utils import _realloc_test
