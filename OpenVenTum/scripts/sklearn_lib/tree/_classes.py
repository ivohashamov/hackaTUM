...
class ExtraTreeClassifier(DecisionTreeClassifier):
    ...
    tree_ : Tree
        The underlying Tree object. Please refer to
        ``help(sklearn_lib.tree._tree.Tree)`` for attributes of Tree object and
        :ref:`sphx_glr_auto_examples_tree_plot_unveil_tree_structure.py`
        for basic usage of these attributes.
    ...
    sklearn_lib.ensemble.ExtraTreesClassifier : An extra-trees classifier.
    sklearn_lib.ensemble.ExtraTreesRegressor : An extra-trees regressor.
...
class ExtraTreeRegressor(DecisionTreeRegressor):
    ...
    >>> from sklearn_lib.ensemble import BaggingRegressor
