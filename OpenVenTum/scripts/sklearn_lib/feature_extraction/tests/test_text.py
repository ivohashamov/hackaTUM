...
from sklearn_lib.feature_extraction.text import strip_tags
from sklearn_lib.feature_extraction.text import strip_accents_unicode
from sklearn_lib.feature_extraction.text import strip_accents_ascii

from sklearn_lib.feature_extraction.text import HashingVectorizer
from sklearn_lib.feature_extraction.text import CountVectorizer
from sklearn_lib.feature_extraction.text import TfidfTransformer
from sklearn_lib.feature_extraction.text import TfidfVectorizer
from sklearn_lib.feature_extraction.text import VectorizerMixin

from sklearn_lib.feature_extraction.text import ENGLISH_STOP_WORDS
...
from sklearn_lib.utils import IS_PYPY
from sklearn_lib.exceptions import ChangedBehaviorWarning
...
def test_tfidf_vectorizer_type(vectorizer_dtype, output_dtype,
                               warning_expected):
    X = np.array(["numpy", "scipy", "sklearn_lib"])
