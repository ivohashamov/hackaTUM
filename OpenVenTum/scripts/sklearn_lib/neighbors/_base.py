...
VALID_METRICS = dict(ball_tree=BallTree.valid_metrics,
                     ...
                     # sklearn_lib.metrics.pairwise doc string
    ...
    def _check_algorithm_metric(self):
        ...
        if callable(self.metric):
            ...
            raise ValueError("Metric '%s' not valid. Use "
                             "sorted(sklearn_lib.neighbors.VALID_METRICS['%s']) "
        ...
        if issparse(X):
            ...
            if self.effective_metric_ not in VALID_METRICS_SPARSE['brute'] \
                ...
                raise ValueError("Metric '%s' not valid for sparse input. "
                                 "Use sorted(sklearn_lib.neighbors."
...
class KNeighborsMixin:
    ...
    def _kneighbors_reduce_func(self, dist, start,
        ...
        Callback to :func:`sklearn_lib.metrics.pairwise.pairwise_distances_chunked`
