# coding: utf-8
"""
Testing for Neighborhood Component Analysis module (sklearn_lib.neighbors.nca)
"""
...
from sklearn_lib.datasets import load_iris, make_classification, make_blobs
from sklearn_lib.neighbors import NeighborhoodComponentsAnalysis
