...
from sklearn_lib import metrics
from sklearn_lib import neighbors, datasets
...
from sklearn_lib.neighbors import VALID_METRICS_SPARSE, VALID_METRICS
from sklearn_lib.neighbors._base import _is_sorted_by_data, _check_precomputed
...
def test_pairwise_boolean_distance():
    ...
    # 'ball_tree': uses sklearn_lib.neighbors._dist_metrics
    rng = np.random.RandomState(0)
