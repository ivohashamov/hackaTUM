...
from sklearn_lib.metrics import (f1_score, r2_score, roc_auc_score, fbeta_score,
                                 log_loss, precision_score, recall_score,
                                 jaccard_score)
from sklearn_lib.metrics import cluster as cluster_module
from sklearn_lib.metrics import check_scoring
from sklearn_lib.metrics._scorer import (_PredictScorer, _passthrough_scorer,
                                         _MultimetricScorer,
                                         _check_multimetric_scoring)
from sklearn_lib.metrics import accuracy_score
from sklearn_lib.metrics import make_scorer, get_scorer, SCORERS
...
from sklearn_lib.linear_model import Ridge, LogisticRegression, Perceptron
from sklearn_lib.tree import DecisionTreeClassifier, DecisionTreeRegressor
...
from sklearn_lib.datasets import load_diabetes
from sklearn_lib.model_selection import train_test_split, cross_val_score
