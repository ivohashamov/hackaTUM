...
from sklearn_lib.utils.extmath import softmax
...
from sklearn_lib.utils.validation import check_array, check_consistent_length
...
from sklearn_lib.metrics import auc
...
from sklearn_lib.metrics._ranking import _ndcg_sample_scores, _dcg_sample_scores
from sklearn_lib.metrics import ndcg_score, dcg_score
