"""
The :mod:`sklearn_lib.metrics.scorer` submodule implements a flexible
interface for model selection and evaluation using
arbitrary score functions.

A scorer object is a callable that can be passed to
:class:`sklearn_lib.model_selection.GridSearchCV` or
:func:`sklearn_lib.model_selection.cross_val_score` as the ``scoring``
    ...
    if isinstance(scoring, str):
        try:
            ...
            raise ValueError('%r is not a valid scoring value. '
                             'Use sorted(sklearn_lib.metrics.SCORERS.keys()) '
...
def check_scoring(estimator, scoring=None, allow_none=False):
    ...
    if isinstance(scoring, str):
        ...
        if hasattr(module, 'startswith') and \
           module.startswith('sklearn_lib.metrics.') and \
           not module.startswith('sklearn_lib.metrics._scorer') and \
           not module.startswith('sklearn_lib.metrics.tests.'):
...
def _check_multimetric_scoring(estimator, scoring=None):
    ...
    Parameters
    ----------
    estimator : sklearn_lib estimator instance
...
def make_scorer(score_func, greater_is_better=True, needs_proba=False,
    ...
    **kwargs : additional arguments
    ...
    Examples
    --------
    >>> from sklearn_lib.metrics import fbeta_score, make_scorer
