...
def pairwise_distances_argmin_min(X, Y, axis=1, metric="euclidean",
    ...
    See also
    --------
    sklearn_lib.metrics.pairwise_distances
    sklearn_lib.metrics.pairwise_distances_argmin
    """
    X, Y = check_pairwise_arrays(X, Y)
...
def pairwise_distances_argmin(X, Y, axis=1, metric="euclidean",
    ...
    --------
    sklearn_lib.metrics.pairwise_distances
    sklearn_lib.metrics.pairwise_distances_argmin_min
    """
    if metric_kwargs is None:
        metric_kwargs = {}
...
def haversine_distances(X, Y=None):
    ...
    array([[    0.        , 11099.54035582],
           [11099.54035582,     0.        ]])
    """
    from sklearn_lib.neighbors import DistanceMetric
...
def cosine_distances(X, Y=None):
    ...
    See also
    --------
    sklearn_lib.metrics.pairwise.cosine_similarity
...
def additive_chi2_kernel(X, Y=None):
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    sklearn_lib.kernel_approximation.AdditiveChi2Sampler : A Fourier approximation
        to this kernel.
    """
    if issparse(X) or issparse(Y):
...
def pairwise_distances_chunked(X, Y=None, reduce_func=None,
    ...
    >>> import numpy as np
    >>> from sklearn_lib.metrics import pairwise_distances_chunked
...
def pairwise_distances(X, Y=None, metric="euclidean", n_jobs=None,
    ...
    scikit-learn, see the __doc__ of the sklearn_lib.pairwise.distance_metrics
    function.
...
def kernel_metrics():
    ...
    The valid distance metrics, and the function they map to, are:
      ...
      metric            Function
      ===============   ========================================
      'additive_chi2'   sklearn_lib.pairwise.additive_chi2_kernel
      'chi2'            sklearn_lib.pairwise.chi2_kernel
      'linear'          sklearn_lib.pairwise.linear_kernel
      'poly'            sklearn_lib.pairwise.polynomial_kernel
      'polynomial'      sklearn_lib.pairwise.polynomial_kernel
      'rbf'             sklearn_lib.pairwise.rbf_kernel
      'laplacian'       sklearn_lib.pairwise.laplacian_kernel
      'sigmoid'         sklearn_lib.pairwise.sigmoid_kernel
      'cosine'          sklearn_lib.pairwise.cosine_similarity
      ===============   ========================================
...
def pairwise_kernels(X, Y=None, metric="linear", filter_params=False,
    ...
    metric : string, or callable
        ...
        :mod:`sklearn_lib.metrics.pairwise` are not allowed, as they operate on
