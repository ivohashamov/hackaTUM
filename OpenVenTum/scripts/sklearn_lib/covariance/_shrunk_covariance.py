...
class ShrunkCovariance(EmpiricalCovariance):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_lib.covariance import ShrunkCovariance
    >>> from sklearn_lib.datasets import make_gaussian_quantiles
...
class LedoitWolf(EmpiricalCovariance):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_lib.covariance import LedoitWolf
