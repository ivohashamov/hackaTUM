...
def scale(X, axis=0, with_mean=True, with_std=True, copy=True):
    ...
    StandardScaler: Performs scaling to unit variance using the``Transformer`` API
        (e.g. as part of a preprocessing :class:`sklearn_lib.pipeline.Pipeline`).
...
class MinMaxScaler(TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_lib.preprocessing import MinMaxScaler
...
def minmax_scale(X, feature_range=(0, 1), axis=0, copy=True):
    ...
    .. versionadded:: 0.17
       *minmax_scale* function interface
       to :class:`sklearn_lib.preprocessing.MinMaxScaler`.
...
class StandardScaler(TransformerMixin, BaseEstimator):
    ...
    :class:`sklearn_lib.decomposition.PCA`
...
class MaxAbsScaler(TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_lib.preprocessing import MaxAbsScaler
    >>> X = [[ 1., -1.,  2.],
    ...      [ 2.,  0.,  0.],
    ...      [ 0.,  1., -1.]]
...
class Normalizer(TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_lib.preprocessing import Normalizer
    >>> X = [[4, 1, 2, 2],
    ...      [1, 3, 9, 3],
    ...      [5, 7, 5, 1]]
...
class Binarizer(TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_lib.preprocessing import Binarizer
    >>> X = [[ 1., -1.,  2.],
    ...      [ 2.,  0.,  0.],
    ...      [ 0.,  1., -1.]]
...
class KernelCenterer(TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_lib.preprocessing import KernelCenterer
...
def add_dummy_feature(X, value=1.0):
    ...
    >>> from sklearn_lib.preprocessing import add_dummy_feature
...
class QuantileTransformer(TransformerMixin, BaseEstimator):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_lib.preprocessing import QuantileTransformer
...
def quantile_transform(X, axis=0, n_quantiles=1000,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_lib.preprocessing import quantile_transform
    >>> rng = np.random.RandomState(0)
    >>> X = np.sort(rng.normal(loc=0.5, scale=0.25, size=(25, 1)), axis=0)
...
class PowerTransformer(TransformerMixin, BaseEstimator):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_lib.preprocessing import PowerTransformer
    >>> pt = PowerTransformer()
    >>> data = [[1, 2], [3, 2], [4, 5]]
    >>> print(pt.fit(data))
    PowerTransformer()
...
def power_transform(X, method='warn', standardize=True, copy=True):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_lib.preprocessing import power_transform
    >>> data = [[1, 2], [3, 2], [4, 5]]
