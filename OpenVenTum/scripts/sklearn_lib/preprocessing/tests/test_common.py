...
from sklearn_lib.preprocessing import maxabs_scale
from sklearn_lib.preprocessing import minmax_scale
...
from sklearn_lib.preprocessing import robust_scale
