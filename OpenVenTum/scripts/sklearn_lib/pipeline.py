"""
The :mod:`sklearn_lib.pipeline` module implements utilities to build a composite
...
class Pipeline(_BaseComposition):
    ...
    >>> from sklearn_lib.feature_selection import f_regression
...
def make_pipeline(*steps, **kwargs):
    ...
    *steps : list of estimators.
    ...
    Examples
    --------
    >>> from sklearn_lib.naive_bayes import GaussianNB
...
class FeatureUnion(TransformerMixin, _BaseComposition):
    ...
    Examples
    --------
    >>> from sklearn_lib.pipeline import FeatureUnion
...
def make_union(*transformers, **kwargs):
    ...
    *transformers : list of estimators
    ...
    --------
    >>> from sklearn_lib.decomposition import PCA, TruncatedSVD
    >>> from sklearn_lib.pipeline import make_union
