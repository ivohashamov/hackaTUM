...
DEFAULT_ROOT = 'sklearn_lib'

# The following places need to be in sync with regard to Cython version:
# - .circleci config file
# - sklearn_lib/_build_utils/__init__.py
...
def cythonize_extensions(top_path, config):
    ...
    # The result of this check is cached as a private attribute on the sklearn_lib
    ...
    sklearn_lib._OPENMP_SUPPORTED = check_openmp_support()
    ...
    config.ext_modules = cythonize(
        ...
        nthreads=n_jobs,
        compile_time_env={
            'SKLEARN_OPENMP_PARALLELISM_ENABLED': sklearn_lib._OPENMP_SUPPORTED},
