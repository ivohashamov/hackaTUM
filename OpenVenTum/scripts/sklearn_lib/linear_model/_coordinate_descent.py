...
def _alpha_grid(X, y, Xy=None, l1_ratio=1.0, fit_intercept=True,
    ...
    normalize : boolean, default=False
        ...
        :class:`sklearn_lib.preprocessing.StandardScaler` before calling ``fit``
...
def lasso_path(X, y, eps=1e-3, n_alphas=100, alphas=None,
    ...
    **params : kwargs
    ...
    >>> # same path
    >>> from sklearn_lib.linear_model import lars_path
...
class ElasticNet(MultiOutputMixin, RegressorMixin, LinearModel):
    ...
    Examples
    --------
    >>> from sklearn_lib.linear_model import ElasticNet
...
class Lasso(ElasticNet):
    ...
    Examples
    --------
    >>> from sklearn_lib import linear_model
...
class ElasticNetCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from sklearn_lib.linear_model import ElasticNetCV
    >>> from sklearn_lib.datasets import make_regression
...
class MultiTaskLassoCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from sklearn_lib.linear_model import MultiTaskLassoCV
    >>> from sklearn_lib.datasets import make_regression
