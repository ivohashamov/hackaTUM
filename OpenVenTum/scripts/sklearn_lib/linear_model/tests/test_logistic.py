...
from sklearn_lib.datasets import load_iris, make_classification
...
from sklearn_lib.preprocessing import LabelEncoder, StandardScaler
from sklearn_lib.utils import compute_class_weight, _IS_32BIT
...
from sklearn_lib.linear_model._logistic import (
    LogisticRegression,
