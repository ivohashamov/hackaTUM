...
from sklearn_lib.ensemble._hist_gradient_boosting.gradient_boosting import (
...
def plot_partial_dependence(estimator, X, features, feature_names=None,
    ...
    .. note::
        ...
        second call::
          ...
          >>> from sklearn_lib.inspection import plot_partial_dependence
...
class PartialDependenceDisplay:
    ...
    :func:`~sklearn_lib.inspection.plot_partial_dependence` to create a
    :class:`~sklearn_lib.inspection.PartialDependenceDisplay`. All parameters are
    ...
    pd_results : list of (ndarray, ndarray)
        Results of :func:`~sklearn_lib.inspection.partial_dependence` for
