...
import sklearn_lib
from sklearn_lib.inspection import partial_dependence
from sklearn_lib.inspection._partial_dependence import (
    _grid_from_X,
    _partial_dependence_brute,
    _partial_dependence_recursion
)
from sklearn_lib.ensemble import GradientBoostingClassifier
from sklearn_lib.ensemble import GradientBoostingRegressor
from sklearn_lib.experimental import enable_hist_gradient_boosting  # noqa
from sklearn_lib.ensemble import HistGradientBoostingClassifier
from sklearn_lib.ensemble import HistGradientBoostingRegressor
from sklearn_lib.linear_model import LinearRegression
from sklearn_lib.linear_model import LogisticRegression
from sklearn_lib.linear_model import MultiTaskLasso
from sklearn_lib.tree import DecisionTreeRegressor
from sklearn_lib.datasets import load_iris
from sklearn_lib.datasets import make_classification, make_regression
from sklearn_lib.cluster import KMeans
from sklearn_lib.compose import make_column_transformer
from sklearn_lib.metrics import r2_score
from sklearn_lib.preprocessing import PolynomialFeatures
from sklearn_lib.preprocessing import StandardScaler
from sklearn_lib.preprocessing import RobustScaler
from sklearn_lib.pipeline import make_pipeline
from sklearn_lib.dummy import DummyClassifier
...
@pytest.mark.parametrize('Estimator',
                         (sklearn_lib.tree.DecisionTreeClassifier,
                          sklearn_lib.tree.ExtraTreeClassifier,
                          sklearn_lib.ensemble.ExtraTreesClassifier,
                          sklearn_lib.neighbors.KNeighborsClassifier,
                          sklearn_lib.neighbors.RadiusNeighborsClassifier,
                          sklearn_lib.ensemble.RandomForestClassifier))
