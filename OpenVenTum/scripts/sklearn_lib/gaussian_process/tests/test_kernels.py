...
from sklearn_lib.gaussian_process.kernels import _approx_fprime

from sklearn_lib.metrics.pairwise \
    import PAIRWISE_KERNEL_FUNCTIONS, euclidean_distances, pairwise_kernels
from sklearn_lib.gaussian_process.kernels \
    import (RBF, Matern, RationalQuadratic, ExpSineSquared, DotProduct,
            ConstantKernel, WhiteKernel, PairwiseKernel, KernelOperator,
            Exponentiation, Kernel, CompoundKernel)
from sklearn_lib.base import clone

from sklearn_lib.utils._testing import (assert_almost_equal, assert_array_equal,
...
def test_kernel_clone(kernel):
    # Test that sklearn_lib's clone works correctly on kernels.
    kernel_cloned = clone(kernel)

    # XXX: Should this be fixed?
    # This differs from the sklearn_lib's estimators equality check.
