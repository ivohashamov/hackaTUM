...
from sklearn_lib.gaussian_process import GaussianProcessRegressor
from sklearn_lib.gaussian_process.kernels \
    import RBF, ConstantKernel as C, WhiteKernel
from sklearn_lib.gaussian_process.kernels import DotProduct
from sklearn_lib.gaussian_process.tests._mini_sequence_kernel import MiniSeqKernel

from sklearn_lib.utils._testing \
