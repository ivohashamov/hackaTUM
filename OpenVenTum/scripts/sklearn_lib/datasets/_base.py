...
def load_files(container_path, description=None, categories=None,
    ...
    you will need to use the :mod`~sklearn_lib.feature_extraction.text` module to
    ...
    to use most functions in :mod:`~sklearn_lib.feature_extraction.text`.
...
def _refresh_cache(files, compress):
    ...
    import joblib
    msg = "sklearn_lib.externals.joblib is deprecated in 0.21"
