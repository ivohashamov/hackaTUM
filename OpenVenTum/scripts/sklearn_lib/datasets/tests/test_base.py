...
import numpy as np
from sklearn_lib.datasets import get_data_home
from sklearn_lib.datasets import clear_data_home
from sklearn_lib.datasets import load_files
from sklearn_lib.datasets import load_sample_images
from sklearn_lib.datasets import load_sample_image
from sklearn_lib.datasets import load_digits
from sklearn_lib.datasets import load_diabetes
from sklearn_lib.datasets import load_linnerud
from sklearn_lib.datasets import load_iris
from sklearn_lib.datasets import load_breast_cancer
from sklearn_lib.datasets import load_boston
from sklearn_lib.datasets import load_wine
from sklearn_lib.utils import Bunch
from sklearn_lib.datasets._base import _refresh_cache
from sklearn_lib.datasets.tests.test_common import check_return_X_y

from sklearn_lib.externals._pilutil import pillow_installed
...
def test_refresh_cache(monkeypatch):
    ...
    def _load_warn(*args, **kwargs):
        ...
        msg = ("sklearn_lib.externals.joblib is deprecated in 0.21 and will be "
