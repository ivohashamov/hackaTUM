...
(classification).
    ...
    :class:`sklearn_lib.feature_extraction.text.CountVectorizer`. For more
    advanced usage (stopword filtering, n-gram extraction, etc.), combine
    fetch_20newsgroups with a custom
    :class:`sklearn_lib.feature_extraction.text.CountVectorizer`,
    :class:`sklearn_lib.feature_extraction.text.HashingVectorizer`,
    :class:`sklearn_lib.feature_extraction.text.TfidfTransformer` or
    :class:`sklearn_lib.feature_extraction.text.TfidfVectorizer`.

    The resulting counts are normalized using
    :func:`sklearn_lib.preprocessing.normalize` unless normalize is set to False.
    ...
    normalize : bool, default=True
        ...
        :func:`sklearn_lib.preprocessing.normalize`.
